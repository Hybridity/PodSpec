  Pod::Spec.new do |s|
    s.name     = 'GPUImage2Hybridity'
    s.version  = '0.2.0'
    s.license  = 'BSD'
    s.summary  = 'An open source iOS framework for GPU-based image and video processing.'
    s.homepage = 'https://github.com/Hybridity/GPUImage2'
    s.author   = { 'Ron Ho' => 'ron@generateapp.com',
        'Brad Larson' => 'contact@sunsetlakesoftware.com' }
    s.source   = { :git => 'https://github.com/Hybridity/GPUImage2.git', :branch => "hybridity-master" }
