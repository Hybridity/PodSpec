...
Pod::Spec.new do |s|
  ...
  s.source            = { :http => 'https://raw.githubusercontent.com/Hybridity/Filterchain-Dist/master/Filterchain.zip?token=AClCQ8pOgoWHi1JNkrNmNNKirHnnCstGks5YxyVBwA%3D%3D' }
